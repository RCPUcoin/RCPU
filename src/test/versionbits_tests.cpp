...
BOOST_AUTO_TEST_CASE(versionbits_computeblockversion)
{
    ...
    for (const auto& chain_type: {ChainType::RCPUMAIN, ChainType::RCPUTESTNET, ChainType::RCPUREGTEST}) {
...

    {
        ...
        const auto chainParams = CreateChainParams(args, ChainType::RCPUREGTEST);
