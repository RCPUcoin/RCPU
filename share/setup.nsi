...
# !RCPU
!define MUI_ICON "/root/rcpu-native/share/pixmaps/rcpu.ico"
!define MUI_WELCOMEFINISHPAGE_BITMAP "/root/rcpu-native/share/pixmaps/nsis-wizard-rcpu.bmp"
!define MUI_HEADERIMAGE
!define MUI_HEADERIMAGE_RIGHT
!define MUI_HEADERIMAGE_BITMAP "/root/rcpu-native/share/pixmaps/nsis-header-rcpu.bmp"
#! RCPU END
...
!define MUI_UNWELCOMEFINISHPAGE_BITMAP "/root/rcpu-native/share/pixmaps/nsis-wizard.bmp"
...
Section -Main SEC0000
    ...
    SetOverwrite on
# !RCPU
    File /root/rcpu-native/release/rcpu-qt
    File /oname=COPYING.txt /root/rcpu-native/COPYING
    File /oname=readme.txt /root/rcpu-native/doc/README_windows_rcpu.txt
    File /root/rcpu-native/share/examples/rcpu.conf
# !RCPU END
    SetOutPath $INSTDIR\share\rpcauth
    File /root/rcpu-native/share/rpcauth/*.*
    SetOutPath $INSTDIR\daemon
# !RCPU
    File /root/rcpu-native/release/rcpud
    File /root/rcpu-native/release/rcpu-cli
    File /root/rcpu-native/release/rcpu-tx
    File /root/rcpu-native/release/rcpu-wallet
    File /root/rcpu-native/release/test_rcpu
# !RCPU END
    SetOutPath $INSTDIR
