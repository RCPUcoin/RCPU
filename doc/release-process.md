...
* Update rcpu.conf and commit, see [gen-rcpu-conf.sh](https://github.com/bitcoin/bitcoin/blob/master/contrib/devtools/README.md#gen-rcpu-confsh).
...
- Update other repositories and websites for new version
  ...
  - Update packaging repo
      ...
      - Push the flatpak to flathub, e.g. https://github.com/flathub/org.bitcoincore.rcpu-qt/pull/2
