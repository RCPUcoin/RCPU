Contributing to RCPU
============================

The RCPU project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "RCPU
...
Before you start contributing, familiarize yourself with the RCPU build
system and tests. Refer to the documentation in the repository on how to build
RCPU and how to run the unit tests, functional tests, and fuzz tests.

There are many open issues of varying difficulty waiting to be fixed.
If you're looking for somewhere to start contributing, check out the
[good first issue](https://github.com/RCPUcoin/RCPU/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or changes that are
[up for grabs](https://github.com/RCPUcoin/RCPU/issues?q=label%3A%22Up+for+grabs%22).
Some of them might no longer be applicable. So if you are interested, but
unsure, you might want to leave a comment on the issue first.

You may also participate in discussions on the
[RCPU GitHub repository](https://github.com/RCPUcoin/RCPU).
...
Communication about RCPU development happens primarily in GitHub issues and
pull requests on the [RCPU repository](https://github.com/RCPUcoin/RCPU).

Discussion about codebase improvements, and any complicated or controversial
consensus or P2P protocol changes, should happen in GitHub issues before
...
RCPU uses a single repository: https://github.com/RCPUcoin/RCPU (both the
node and GUI code live here).
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to rcpu-qt
...
fork of RCPU copies the merge. Instead, make any username mentions in a
subsequent comment to the PR.

### Translation changes

Note that translations should not be submitted as pull requests. Please see
[Translation Process](https://github.com/RCPUcoin/RCPU/blob/main/doc/translation_process.md)
...
When a pull request conflicts with the target branch, you may be asked to rebase it on top of the current target branch.
    ...
    git fetch https://github.com/RCPUcoin/RCPU  # Fetch the latest upstream commit
...
The following applies to code changes to the RCPU project (and related
projects), and is not to be confused with overall Bitcoin
Network Protocol consensus changes.

Whether a pull request is merged into RCPU rests with the project merge
maintainers.
...
Patches that change RCPU consensus rules are considerably more involved than
...
Where a patch set proposes to change the RCPU consensus, it must have been
discussed extensively in GitHub issues, be accompanied by a widely
...
https://github.com/RCPUcoin/RCPU/pull/16189).

Also see the [backport.py script](
https://github.com/RCPUcoin/RCPU#backport).
